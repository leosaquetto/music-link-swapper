...
- A burst of cache misses can spend YouTube Data API quota and slow down provider calls.
...
- Monitor YouTube Data API quota after matching changes.
...
- Run `npm run check`.
- Smoke-test one Spotify, one Apple Music, and one YouTube Music input.
