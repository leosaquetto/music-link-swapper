...
const SVG_ICONS = {
  ...
  amazonMusic: `<svg id="Camada_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" aria-hidden="true"><path d="M622.6,539.3c29.9-12.1,83.1-28.2,99.2-8.8,17.3,21-4.6,66.6-24.7,102" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M72,553.3c47.3,37.6,186.9,95,335.7,95,97.7,2.3,193.3-26.7,273.3-82.7" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M303.4,281.8v88.8c0,29.7,24,53.7,53.7,53.7h0c29.7,0,53.7-24,53.7-53.7v-88.8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><line x1="410.9" y1="370.6" x2="410.9" y2="424.3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M34.4,338.3c0-29.7,24-53.7,53.7-53.7h0c29.7,0,53.7,24,53.7,53.7v86" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><line x1="34.4" y1="284.6" x2="34.4" y2="424.3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M141.9,338.3c0-29.7,24-53.7,53.7-53.7h0c29.7,0,53.7,24,53.7,53.7v86" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><circle cx="611.6" cy="215.9" r="18.8" transform="translate(300.7 785.2) rotate(-80.8)" fill="currentColor"/><line x1="611.8" y1="281.8" x2="611.8" y2="424.3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M468.3,412.2c12.6,9.7,28.4,14,44.3,12h12c19.6,0,35.6-15.9,35.6-35.6h0c0-19.6-15.9-35.6-35.6-35.6h-24.2c-19.6,0-35.6-15.9-35.6-35.6h0c0-19.6,15.8-35.6,35.6-35.6h12c15.7-2,31.7,2.3,44.3,12" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/><path d="M765.6,397.3c-9.6,16.8-27.4,27-46.7,27h0c-29.7,0-53.7-24-53.7-53.7v-34.9c0-29.7,24-53.7,53.7-53.7h0c19.3,0,37.1,10.3,46.6,27" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24px"/></svg>`,
